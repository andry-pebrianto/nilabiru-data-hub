...
| **nilabiru-ollama**              | `ollama/ollama:0.6.8`                         | `11434`           | Local AI model inference engine (CPU-only); models stored on SATA drive                                                   |
| **nilabiru-open-webui**          | `ghcr.io/open-webui/open-webui:v0.5.20`       | `3000`            | Web-based chat UI for interacting with Ollama models                                                                      |
